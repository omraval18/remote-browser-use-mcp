...
- Checked-in golden events under `tests/golden-events/` cover legacy done, running/browser-live, artifact/image, and sub-agent/follow-up event shapes; tests verify import compatibility and TUI projection from imported events.
